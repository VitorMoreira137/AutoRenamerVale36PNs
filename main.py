...
def interface_editar_carimbo():
    ...
    var4 = ctk.StringVar()
    var5 = ctk.StringVar()
    var1B = ctk.StringVar()  # Armazena o que usuário digitar
    var2B = ctk.StringVar()
    var3B = ctk.StringVar()
    var4B = ctk.StringVar()
    var5B = ctk.StringVar()
    ...
    # B0 = ctk.CTkButton(janela, text="Selecionar Pasta", width=70, command=selecionar_pasta_PROJETO)
    ...
    janela.mainloop()  # Mantém a janela aparecendo
...
[LCMilePost, rev, HouseKM, project_number, LCMilePostB, revB, HouseKMB, project_numberB, firstProj, text, textB] = interface_editar_carimbo()
# print(f"{folder}\n{LCMilePost}\n{rev}\n{HouseKM}\n{project_number}\n{LCMilePostB}\n{revB}\n{HouseKMB}\n{project_numberB}\n{firstProj}\n{text}\n{textB}")
